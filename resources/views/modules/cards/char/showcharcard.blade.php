...
<div style='position:relative; padding-bottom:70.80%'><iframe src='https://gfycat.com/ifr/{{ $char->getGifs()[0]->url}}' frameborder='0' scrolling='no' width='100%' height='100%' style='position:absolute;top:0;left:0;' allowfullscreen></iframe></div>
					@endif
			</div>
		</div>
